...
export function AtlantisDemo() {
  ...
  return (
    <>
      ...
      {/* ═══ HERO ═══ */}
      <section ref={parallaxRef} className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden bg-text-head">
        <motion.div className="absolute inset-0 z-0" style={{ y: bgY }}>
          <img
            src="/demo/atlantis/storefront-wide.webp"
            alt="Atlantis 10 storefront"
            className="w-full h-[120%] object-cover opacity-30"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-text-head via-text-head/60 to-text-head/40" />
        </motion.div>

        {/* Accent glow */}
        <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] rounded-full bg-[#FFD700]/10 blur-[150px] pointer-events-none" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-[#00FF88]/10 blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto px-6 pt-32 pb-20 relative z-10">
          ...
          >
            ...
            <span className="text-white/90 text-sm font-medium">Prezentare exclusiva pentru Atlantis</span>
          </motion.div>

          <h1 className="text-[clamp(2.5rem,7vw,5.5rem)] font-bold text-white leading-[1.05] mb-6">
          ...
          >
            Cum ar arata vitrinele celor <span className="text-[#00FF88] font-bold">10 magazine Atlantis</span> cu ecrane LED transparente care atrag clienti de pe trotuar.
          </motion.p>
      ...
      <section className="py-20 md:py-32 bg-primary relative overflow-hidden rounded-t-[2.5rem] md:rounded-t-[4rem] border-t-2 border-x-2 border-text-head -mt-12 z-[4]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-10%" }}
            transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            className="bg-text-head border-2 border-text-head rounded-3xl p-8 md:p-12 shadow-[8px_8px_0px_0px_#00FF88]"
          >
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
              {stores.map((store, i) => (
                <motion.div
                  ...
                  className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 text-center hover:bg-white/10 hover:border-[#00FF88]/30 transition-all duration-300 group"
                >
                  <div className="w-10 h-10 bg-[#FFD700] rounded-lg border-2 border-white/20 flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                    <Store className="w-5 h-5 text-text-head" />
                  </div>
                  <p className="text-white font-bold text-sm leading-tight">Atlantis</p>
                  <p className="text-[#00FF88] font-mono text-xs font-bold">{store}</p>
                </motion.div>
              ))}
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { icon: Smartphone, text: "Control de pe telefon", sub: "Pentru toate locatiile" },
                { icon: Sparkles, text: "Continut generat cu AI", sub: "Promotii automate" },
                { icon: Monitor, text: "Dashboard centralizat", sub: "Un singur cont" },
              ].map(({ icon: Icon, text, sub }, i) => (
                <div key={i} className="flex items-center gap-4 bg-white/5 rounded-xl border border-white/10 p-4">
                  <div className="w-10 h-10 bg-[#00FF88] rounded-lg border-2 border-text-head flex items-center justify-center shrink-0">
                    <Icon className="w-5 h-5 text-text-head" />
                  </div>
                  <div>
